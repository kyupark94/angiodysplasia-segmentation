...
class SquarePaddingTraining:
    def __init__(self, transforms):
        self.transforms = transforms
    def __call__(self, mask=None):
        img = cv2.copyMakeBorder(img, 0, 0, 37, 37, cv2.BORDER_CONSTANT, value = BLACK)
        return img, mask

class SquarePaddingTesting:
    def __init__(self, transforms):
        self.transforms = transforms
    def __call__(self, mask=None):
        img = cv2.copyMakeBorder(img, 134, 134, 55, 55, cv2.BORDER_CONSTANT, value = BLACK)
        return img, mask
